<?php
require_once dirname(dirname(dirname(__DIR__))) . DIRECTORY_SEPARATOR . 'config.php'; // Include your config file

// Initialize cURL
$ch = curl_init();

// Use the URL constant defined in config.php
$url = URL_SEND_CONTROLLER; // Use the defined URL constant
