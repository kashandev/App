...
//end of function view on key enter //
   ...
   //function approve//
      ...
      function approve(wtid='',uid='',aid='',uname='')
      ...
      $.ajax({
        ...
        url:"approve/approve-withdrawal.php",

        method:"POST",

        data:{wtid : wtid, uid : uid, aid : aid, uname : uname},
        ...
        { 
         ...
         setTimeout(function(){
          ...
          $('new-table').find('#row'+wtid).remove();
 ...
 //function disapprove//
      ...
      function disapprove(wtid='',aid='',uname='')
      ...
      $.ajax({
        ...
        url:"approve/dis-approve-withdrawal.php",

        method:"POST",

        data:{wtid : wtid, aid : aid, uname : uname},
...
$(document).ready(function () {
    ...
    // check row function //
      ...
      $('body').on('click','.wtid',function (e) {

         $('.wtid:checked').each(function(){
       ...
       $('body').on('click','.btn-uncheck',function(){
        ...
        // show modal function //
                   ...
                   $('body').on('click','.btn-approve',function(){
                     ...
                     thismtxt ='<h3><strong class="mttxt"> Approve Withdrawal<strong></strong></h3>';
                    ...
                    $('body').on('click','.btn-dis-approve',function(){
                     ...
                     thismtxt ='<h3><strong class="mttxt">DisApprove Withdrawal <strong></strong></h3>';
