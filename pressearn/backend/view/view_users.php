...
if ($type == 'all' && $search == '' || $search != '')
{
    ...
    where users.isdeleted = 0 and roles.role not in('cp admin') order by userid desc";
    $thismsglabel = 'There is no all users found';
    $thisheading = 'All Users';
}
if ($type == 'new' && $search == '' || $search != '')
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid where users.status = '" . $type . "' and users.isdeleted = 0 and users.isnew = 1 and roles.role not in('cp admin') order by userid desc";
...
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid where users.status = '" . $type . "' and users.isdeleted =0 and users.istop = 1 and roles.role not in('cp admin','admin','agent') order by userid desc";
...
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid where users.isdeleted = 1 and users.isblock = 1 and roles.role not in('cp admin') order by userid desc";
...
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid where users.isdeleted = 1 and users.isblock = 0 and roles.role not in('cp admin') order by userid desc";
...
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid 
    where users.isdeleted = 0 and roles.role not in('cp admin') order by userid desc $limit";
...
if ($type == 'new' && $search == '' || $search != '')
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid  where users.status = '" . $type . "' and users.isdeleted = 0 and users.isnew = 1 and roles.role not in('cp admin') order by userid desc $limit ";
    $thismsglabel = 'There is no new users found';
        $thisheading = 'New Users';
}
...
if ($type == 'top' && $search == '' || $search != '')
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid where users.status = '" . $type . "' and users.isdeleted = 0 and users.istop = 1 and roles.role not in('cp admin','admin','agent') order by userid desc $limit ";
   $thismsglabel = 'There is no top users found';
     $thisheading = 'Top Users';
}
...
if ($type == 'block' && $search == '' || $search != '')
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid where users.isdeleted = 1 and users.isblock = 1 and roles.role not in('cp admin') order by userid desc $limit";
    $thismsglabel = 'There is no blacklisted users found';
...
if ($type == 'deleted' && $search == '' || $search != '')
{
    $all_qry = "SELECT users.*,roles.* from users inner join roles on roles.roleid = users.roleid where users.isdeleted = 1 and users.isblock = 0 and roles.role not in('cp admin') order by userid desc $limit";
    $thismsglabel = 'There is no deleted users found';
    $thisheading = 'Deleted Users';
}
