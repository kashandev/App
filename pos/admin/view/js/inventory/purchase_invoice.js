...
function calculateTotal() {
    ...
    var $cash_returned = $('#cash_returned').val() || 0;
    var $balance_amount = $cash_received - $cash_returned;
    ...
    $('#cash_received').val(roundUpto($cash_paid,0));
    $('#cash_returned').val(roundUpto($cash_returned,0));
