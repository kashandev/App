...
<!--                                     <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-3">
                                      ...
                                      <br>
                                      <a href="#" class="btn btn-primary pull-left" onClick="AddBrand=window.open('<?php echo $href_product_form ?>','AddBrand','width=600,height=600'); return false;"><i class="fa fa-plus"> Add New Item</i></a>                            
                                    </div>
                                </div>
                                <div class="row hide">
                                    <div class="col-sm-3">
            ...
            <input type="text" id="cash_received" name="cash_received" value="<?php echo (int) $cash_received; ?>" class="form-control fInteger" onchange="calculateTotal();" />
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="cash_returned" name="cash_returned" value="<?php echo $cash_returned; ?>" class="form-control fInteger" placeholder="0" onchange="calculateTotal();" />
                                        </div>
                                    </div>
