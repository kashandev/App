...
<!--                                 <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group col-sm-9">
                                            <label><?php echo $lang['model']; ?>
                                                <button class="add_model" id="add_model" onclick="getmodels()">
                                                    <i class="fa fa-plus"></i>
                                                </button>
                                            </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group col-sm-9">
                                            <label><span class="required">*</span>&nbsp;<?php echo $lang['model']; ?></label>
                                            <select class="form-control" id="model_id" name="model_id" >
                                                <option value="">&nbsp;</option>
                                                <?php foreach($models as $model): ?>
                                                <option value="<?php echo $model['model_id']; ?>" <?php echo ($model['model_id'] == $model_id ? 'selected="selected"': ''); ?>><?php echo $model['name']; ?></option>
                                        ...
                                        <label style="visibility: hidden;">Add Produ Category</label>
                                        <a href="#" class="btn btn-primary btn-xs pull-left" onClick="AddBrand=window.open('<?php echo $href_model_form ?>','AddBrand','width=600,height=600,top=50,left=200'); return false;"><i class="fa fa-plus"></i></a>
                                        <!-- <div class="form-group col-sm-2 pull-left">
                                            <label style="visibility: hidden;">Add Category</label>
                                            <a href="#" class="btn btn-primary btn-xs" onClick="AddBrand=window.open('<?php echo $href_model_form ?>','AddBrand','width=600,height=600,top=50,left=200'); return false;"><i class="fa fa-plus"></i></a>
                                        </div> -->
                                    </div>
