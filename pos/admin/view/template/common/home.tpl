                ...
                <div class="panel-collapse in" id="collapseOne" style="height: auto;">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div style="font-size: 16px" class="col-md-3"><i class="fa fa-arrow-right fa-lg"></i>&nbsp;&nbsp;<a target="_blank" href="<?php echo $inventory_purchase_invoice; ?>"><?php echo $lang['inventory_order_booking']; ?></a></div>
                            <div style="font-size: 16px" class="col-md-3"><i class="fa fa-arrow-right fa-lg"></i>&nbsp;&nbsp;<a target="_blank" href="<?php echo $order_booking_report; ?>"><?php echo $lang['order_booking_report']; ?></a></div>
