...
//        }
        ...
        $this->data['sale_tax_report'] = $this->url->link('report/sale_tax_report', '&token=' . $this->session->data['token']);
            ...
            // Url Add Inventory //
        $this->data['inventory_supplier'] = $this->url->link('setup/supplier', '&token=' . $this->session->data['token']);
        ...
        $this->data['inventory_job_order'] = $this->url->link('inventory/job_order', '&token=' . $this->session->data['token']);
        $this->data['inventory_job_order_estimate'] = $this->url->link('inventory/job_order_estimate', '&token=' . $this->session->data['token']);
        ...
        $this->data['href_report_sale_tax_invoice'] = $this->url->link('report/sale_tax_report', 'token=' . $this->session->data['token'], 'SSL');
            ...
            // End Work
                ...
                $total_supplier = $this->model['supplier']->getTotalSupplier();
                $this->data['total_supplier'] = $total_supplier['total_supplier'];
