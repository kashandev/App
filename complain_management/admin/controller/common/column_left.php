...
class ControllerCommonColumnLeft extends Controller {
    ...
    public function index() {
        ...
        $this->data['href_administrator_dashboard'] = $this->url->link('setup/dashboard', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['href_setup_message_template'] = $this->url->link('setup/message_template', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->data['href_inventory_dashboard'] = $this->url->link('inventory/dashboard', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['href_job_order'] = $this->url->link('inventory/job_order', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['href_job_order_estimate'] = $this->url->link('inventory/job_order_estimate', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['href_product_issuance'] = $this->url->link('inventory/product_issuance', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['href_repair_data_report'] = $this->url->link('report/repair_data_report', 'token=' . $this->session->data['token'], 'SSL');

            $this->data['href_job_order_report'] = $this->url->link('report/job_order_report', 'token=' . $this->session->data['token'], 'SSL');
