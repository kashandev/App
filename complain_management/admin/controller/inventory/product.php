...
//        $this->data['action_ajax'] = $this->url->link($this->getAlias() . '/getAjaxLists', 'token=' . $this->session->data['token'], 'SSL');
    ...
    public function exportDataExcel()
    {
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, 'Cost Price')->getStyle('F'.$rowCount)->getFont()->setBold( true );
        $objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, 'Sale Price')->getStyle('G'.$rowCount)->getFont()->setBold( true );
        ...
        foreach($results as $key => $detail) {
            ...
            $objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, $detail['cost_price']);
            $objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, $detail['sale_price']);
    ...
    public function getAjaxLists() {
        ...
        $data = array();
        $aColumns = array('action','product_category','product_sub_category','brand', 'product_code' , 'name','unit','cost_price','sale_price', 'created_at','check_box');
