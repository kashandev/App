...
//            $where .= " AND is_post=1";
    ...
    public function printDocument() {
        ...
        $pdf->Cell(50, 8, 'Product Name', 1, false, 'C', 1, '', 1);
        $pdf->Cell(25, 8, 'Warehouse', 1, false, 'C', 1, '', 1);
        $pdf->Cell(12, 8, 'Unit', 1, false, 'C', 1, '', 1);
        $pdf->Cell(15, 8, 'Quantity', 1, false, 'C', 1, '', 1);
        $pdf->Cell(15, 8, 'Rate', 1, false, 'C', 1, '', 1);
        $pdf->Cell(20, 8, 'Dicount Amount', 1, false, 'C', 1, '', 1);
        $pdf->Cell(20, 8, 'Tax Amount', 1, false, 'C', 1, '', 1);
        ...
        $total_amount = 0;
        foreach($details as $detail) {
            $pdf->Cell(20, 8, $detail['product_code'], 'L', false, 'C', 0, '', 1);
            $pdf->Cell(50, 8, html_entity_decode($detail['product_name']), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(25, 8, html_entity_decode($detail['warehouse']), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(12, 8, $detail['unit'], 'L', false, 'C', 0, '', 1);
            $pdf->Cell(15, 8, number_format($detail['qty'],2), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(15, 8, number_format($detail['rate'],2), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(20, 8, number_format($detail['discount_amount'],2), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(20, 8, number_format($detail['tax_amount'],2), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(20, 8, number_format($detail['amount'],2), 'L,R', false, 'C', 0, '', 1);
...
class PDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(20, 7, 'Document No.: ', 0, false, 'L', 0, '', 0, false, 'M', 'M');
        ...
        $this->Cell(40, 7, html_entity_decode($this->data['partner_name']), 0, false, 'L', 0, '', 0, false, 'M', 'M');
