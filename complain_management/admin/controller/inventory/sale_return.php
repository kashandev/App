...
//        $pdf->SetAutoPageBreak(TRUE, PDF_MARGIN_BOTTOM);
        ...
        $pdf->Cell(20, 7, 'Document No : ', 0, false, 'R', 0, '', 0, false, 'M', 'M');
        ...
        foreach($details as $detail) {
            ...
            $pdf->Cell(110, 8, html_entity_decode($detail['product_name']), 'L', false, 'L', 0, '', 1);
