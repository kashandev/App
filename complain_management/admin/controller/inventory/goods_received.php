...
//    }
    ...
    public function printDocument() {
        ...
        $pdf->Cell(22, 8, 'Product Code', 1, false, 'C', 1, '', 1);
        $pdf->Cell(65, 8, 'Product Name', 1, false, 'C', 1, '', 1);
        $pdf->Cell(40, 8, 'Warehouse', 1, false, 'C', 1, '', 1);
        $pdf->Cell(15, 8, 'Unit', 1, false, 'C', 1, '', 1);
        $pdf->Cell(19, 8, 'Quantity', 1, false, 'C', 1, '', 1);
        $pdf->Cell(19, 8, 'Rate', 1, false, 'C', 1, '', 1);
        ...
        $total_amount = 0;
        foreach($details as $detail) {
            $pdf->Cell(22, 8, $detail['product_code'], 'L', false, 'C', 0, '', 1);
            $pdf->Cell(65, 8, html_entity_decode($detail['product_name']), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(40, 8, html_entity_decode($detail['warehouse']), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(15, 8, $detail['unit'], 'L', false, 'C', 0, '', 1);
            $pdf->Cell(19, 8, number_format($detail['qty'],2), 'L', false, 'C', 0, '', 1);
            $pdf->Cell(19, 8, number_format($detail['rate'],4), 'L', false, 'C', 0, '', 1);
