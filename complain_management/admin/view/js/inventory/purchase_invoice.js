...
$(document).on('click','.btnAddGrid', function() {
    ...
    $html += '</td>';
    $html += '<td>';
    $html += '<input  type="text" onchange="getProductByCode(this);" style="min-width: 100px;" class="form-control code1" name="purchase_invoice_details['+$grid_row+'][product_code]" id="purchase_invoice_detail_product_code_'+$grid_row+'" value="" />';
    $html += '</td>';
    $html += '<td>';
    $html += '<div class="input-group">';
    $html += '<select style="min-width: 300px;" onchange="getProductById(this);" class="form-control select2 code1" id="purchase_invoice_detail_product_id_'+$grid_row+'" name="purchase_invoice_details['+$grid_row+'][product_id]" >';
...
//    });
    ...
    $html += '</td>';
    $html += '<td>';
    $html += '<input onchange="calculateAmount(this);" style="min-width: 100px;" type="text" class="form-control fPDecimal" name="purchase_invoice_details['+$grid_row+'][rate]" id="purchase_invoice_detail_rate_'+$grid_row+'" value="0.00" />';
    $html += '</td>';
    $html += '<td>';
    $html += '<input type="text" style="min-width: 100px;" class="form-control fPDecimal" name="purchase_invoice_details['+$grid_row+'][amount]" id="purchase_invoice_detail_amount_'+$grid_row+'" value="0.00" readonly="true" />';
    $html += '</td>';
    $html += '<td>';
    $html += '<input onchange="calculateDiscountAmount(this);" type="text" style="min-width: 100px;" class="form-control fPDecimal" name="purchase_invoice_details['+$grid_row+'][discount_percent]" id="purchase_invoice_detail_discount_percent_'+$grid_row+'" value="0" />';
    $html += '</td>';
...
function calculateDiscountAmount($obj) {
    ...
    var $amount = parseFloat($('#purchase_invoice_detail_amount_' + $row_id).val() || 0.0000);
...
function calculateTotal() {
    ...
    var $cash_paid = $('#cash_paid').val() || 0.00;
    ...
    $('#cash_paid').val(roundUpto($cash_paid,2));
