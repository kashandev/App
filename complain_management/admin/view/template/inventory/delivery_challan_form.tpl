...
<div class="row">
    <div class="col-lg-12">
        <div class="table-responsive form-group">
            <table id="tblDeliveryChallan" class="table table-striped table-bordered" style="width: 1300px !important;max-width: 1300px !important;">
                <thead>
                <tr align="center">
                ...
                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td>
                        <input type="text" class="form-control " name="delivery_challan_details[<?php echo $grid_row; ?>][description]" id="delivery_challan_detail_description_<?php echo $grid_row; ?>" value="<?php echo htmlentities($detail['description']); ?>" />
                    </td>
                    <td>
                        <select onchange="getWarehouseStock(this);" class="required form-control select2" id="delivery_challan_detail_warehouse_id_<?php echo $grid_row; ?>" name="delivery_challan_details[<?php echo $grid_row; ?>][warehouse_id]" >
                            <option value="">&nbsp;</option>
