                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <table id="tblBranchStockTransfer" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                                                ...
                                                <td>
                                                    <input onchange="calculateRowTotal(this);" type="text" class="form-control fPDecimal" name="branch_stock_transfer_details[<?php echo $grid_row; ?>][rate]" id="branch_stock_transfer_detail_rate_<?php echo $grid_row; ?>" value="<?php echo $detail['rate']; ?>" />
