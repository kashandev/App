                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="#" method="post" enctype="multipart/form-data" id="form">
                                <table id="dataTable" class="table table-striped table-bordered table-hover" align="center" style="width: 150%;">
                                    <thead>
                                    <tr>
                                        <td align="center" style="width: 75px;"><?php echo $lang['action']; ?></td>
                                        <td align="center"><?php echo $lang['product_category']; ?></td>
                                        ...
                                        <!-- <td align="center"><?php echo $lang['serial_no']; ?></td> -->
                                        <td align="center" style="width: 280px;"><?php echo $lang['name']; ?></td>
                                        <td align="center"><?php echo $lang['unit']; ?></td>
                                        <td align="center"><?php echo $lang['cost_price']; ?></td>
                                        <td align="center"><?php echo $lang['sale_price']; ?></td>
