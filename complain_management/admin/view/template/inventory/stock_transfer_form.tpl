                ...
                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td style="min-width: 250px;">
                        <div class="input-group">
                            <select onchange="getProductById(this);" class="form-control select2" id="stock_transfer_detail_product_id_<?php echo $grid_row; ?>" name="stock_transfer_details[<?php echo $grid_row; ?>][product_id]" >
                                <option value="">&nbsp;</option>
