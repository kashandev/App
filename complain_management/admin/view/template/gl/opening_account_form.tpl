                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <table id="tblOpeningAccountDetail" class="table table-striped table-bordered">
                                            ...
                                            <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                                                ...
                                                <td>
                                                    <select onchange="getCoaLevel3ByPartner(<?php echo $grid_row; ?>);"  class="form-control" id="opening_account_detail_coa_level3_id_<?php echo $grid_row; ?>" name="opening_account_details[<?php echo $grid_row; ?>][coa_level3_id]">
                                                        <option value="0" >&nbsp;</option>
