        ...
        <ul class="sidebar-menu">
                ...
                <ul class="treeview-menu">
                    <li class="level2">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li data-route="setup/message_template"><a href="<?php echo $href_setup_message_template; ?>"><i class="fa fa-arrow-right"></i><?php echo $lang['setup_message_template']; ?></a></li>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="level2">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li data-route="inventory/job_order"><a href="<?php echo $href_job_order; ?>"><i class="fa fa-arrow-right"></i><?php echo $lang['inventory_job_order']; ?></a></li>
                            <li data-route="inventory/job_order_estimate"><a href="<?php echo $href_job_order_estimate; ?>"><i class="fa fa-arrow-right"></i><?php echo $lang['inventory_job_order_estimate']; ?></a></li>
            ...
            <li class="treeview level1">
                ...
                <ul class="treeview-menu">
                   ...
                   <li data-route="report/job_order_report">
                        <a href="<?php echo $href_job_order_report; ?>"><i class="fa fa-arrow-right"></i><?php echo $lang['job_order_report']; ?></a>
                    </li>

                  <li data-route="report/repair_data_report">
                        <a href="<?php echo $href_repair_data_report; ?>"><i class="fa fa-arrow-right"></i><?php echo $lang['repair_data_report']; ?></a>
                    </li>

                            <li data-route="report/sale_tax_report"><a href="<?php echo $href_report_sale_tax_invoice; ?>"><i class="fa fa-arrow-right"></i><?php echo $lang['report_sale_invoice']; ?></a></li>
                        </ul>
                    </li>
