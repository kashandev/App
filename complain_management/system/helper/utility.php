...
$url =  "https://api.t2telo.com/api/sendsms?id=".urlencode($id)."&pass=".urlencode($pass)."&mobile=".urlencode($mobile)."&brandname=".urlencode($brand_name)."&msg=".urlencode($message)."";
 // the API request using cURL
$ch = curl_init();
// Set the url
