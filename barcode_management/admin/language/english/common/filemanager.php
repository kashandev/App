...
$_['error_filename']   = 'Warning: Filename must be between 3 and 255 characters long.';
...
$_['error_move']       = 'Warning: Destination directory does not exist.';
$_['error_copy']       = 'Warning: Can not copy this file or directory.';
$_['error_rename']     = 'Warning: Can not rename this directory.';
$_['error_file_type']  = 'Warning: Incorrect file type. Please choose a valid file.';
$_['error_file_size']  = 'Warning: The file size is too large. Please ensure it is smaller than 300kb and no more than 1000px height or width.';
$_['error_uploaded']   = 'Warning: File could not be uploaded for an unknown reason. Please open a support ticket.';
