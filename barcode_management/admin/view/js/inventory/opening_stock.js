...
$(document).on('click','.btnAddGrid', function() {
    ...
    $html += '</td>';
    $html += '<td>';
    $html += '<input onchange="getProductByCode(this);" type="text" style="min-width: 100px;" class="form-control" name="opening_stock_details['+$grid_row+'][product_code]" id="opening_stock_detail_product_code_'+$grid_row+'" value="" />';
    $html += '</td>';
    $html += '<td>';
    $html += '<div class="input-group">';
    $html += '<select style="min-width: 300px;" onchange="getProductById(this);" class="form-control select2" id="opening_stock_detail_product_id_'+$grid_row+'" name="opening_stock_details['+$grid_row+'][product_id]" >';
...
//    });
    ...
    $html += '</td>';
    $html += '<td>';
    $html += '<input onchange="calculateAmount(this);" style="min-width: 100px;" type="text" class="form-control fPDecimal" name="opening_stock_details['+$grid_row+'][qty]" id="opening_stock_detail_qty_'+$grid_row+'" value="1" />';
    $html += '</td>';
    $html += '<td>';
    ...
    $html += '<input type="text" class="form-control" name="opening_stock_details['+$grid_row+'][unit]" id="opening_stock_detail_unit_'+$grid_row+'" value="" />';
    $html += '</td>';
    $html += '<td>';
    $html += '<input onchange="calculateAmount(this);" style="min-width: 100px;" type="text" class="form-control fPDecimal" name="opening_stock_details['+$grid_row+'][rate]" id="opening_stock_detail_rate_'+$grid_row+'" value="0.00" />';
    $html += '</td>';
    $html += '<td>';
    $html += '<input type="text" style="min-width: 100px;" class="form-control fPDecimal" name="opening_stock_details['+$grid_row+'][amount]" id="opening_stock_detail_amount_'+$grid_row+'" value="0.00" readonly="true" />';
    $html += '</td>';
    $html += '<td>';
    $html += '<a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a>';
    $html += '</td>';
