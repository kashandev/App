...
function fillGrid($obj) {
    ...
    $html += '</td>';
    $html += '<td>';
    $html += '<select class="form-control select2" id="purchase_return_detail_warehouse_id_'+$grid_row+'" name="purchase_return_details['+$grid_row+'][warehouse_id]" >';
    $html += '<option value="">&nbsp;</option>';
    ...
    $('#tblPurchaseInvoice tbody').html($html);
    ...
    $.ajax({
        ...
        success: function(json) {
            if(json.success)
            {
                ...
                $('#purchase_return_detail_product_id_'+$row_id).select2('destroy');
                $('#purchase_return_detail_product_id_'+$row_id).val('');
                $('#purchase_return_detail_product_id_'+$row_id).select2({width:'100%'});
...
function setProductInformation($obj) {
    ...
    $('#purchase_return_detail_product_id_'+$row_id).select2('destroy');
    $('#purchase_return_detail_product_id_'+$row_id).val($data['product_id']);
    $('#purchase_return_detail_product_id_'+$row_id).select2({width: '100%'});
}
