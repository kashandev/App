...
function getSubProjects($obj)
{
    ...
    $project_id = $('#payments_detail_project_id_' + $row_id).val();
    $.ajax({
        ...
        success: function(json) {
            if(json.success)
            {
                $('#payments_detail_sub_project_id_'+$row_id).select2('destroy');
                $('#payments_detail_sub_project_id_'+$row_id).select2({'width':'100%'});
                $('#payments_detail_sub_project_id_'+$row_id).html(json.html).trigger('change');
            }
            else {
                alert(json.error);
            }
...
{
    $project_id = $('#payments_detail_project_id_' + $row_id).val();
    $sub_project_id = $('#payments_detail_sub_project_id_' + $row_id).val();
    $.ajax({
        url: $UrlGetJobOrders,
        dataType: 'json',
        type: 'post',
        ...
        success: function(json) {
            if(json.success)
            {
                $('#payments_detail_job_order_id_'+$row_id).select2({'width':'100%'});
                $('#payments_detail_job_order_id_'+$row_id).html(json.html);
            }
            else {
                alert(json.error);
            }
...
$(document).on('change','#partner_id', function() {
    ...
    $.ajax({
        ...
        mimeType:"multipart/form-data",
        beforeSend: function() {
            $('#lblRefDocumentNo').after('<i id="loader" class="fas fa-spinner fa-spin"></i>');
        },
        complete: function() {
            $('#loader').remove();
        },
...
//        $html += '<td >';
//        $html += '<input type="hidden" id="payments_detail_project_id_'+ $grid_row +'" name="payments_details['+$grid_row+'][project_id]" value="">';
//        $html += '<input type="text" value="'+$document['project']+'" readonly class="form-control">';
//        $html += '</td>';
//
//        $html += '<td>';
//        $html += '<input  type="hidden" id="payments_detail_sub_project_id_'+ $grid_row +'" name="payments_details['+$grid_row+'][sub_project_id]" value="">';
//        $html += '<input type="text" value="'+$document['sub_project']+'" readonly class="form-control">';
//        $html += '</td>';
//
//        $html += '<td style="width: 200px">';
//        $html += '<select class="form-control" id="payments_detail_job_order_id_'+ $grid_row +'" name="payments_details['+$grid_row+'][job_order_id]">';
//        $html += '<option value="">&nbsp;</option>';
//        $html += '</select>';
//        $html += '</td>';

        $html += '<td>';
        $html += '<input type="text" class="form-control fDecimal" name="payments_details['+$grid_row+'][document_amount]" id="payments_detail_document_amount_'+$grid_row+'" value="'+roundUpto($document['document_amount'],2)+'" readonly="true"/>';
        $html += '</td>';
        $html += '<td>';
        $html += '<input type="text" class="form-control fDecimal" id="payments_detail_balance_amount_'+$grid_row+'" value="'+roundUpto($document['outstanding_amount'],2)+'" readonly="true" name="payments_details['+$grid_row+'][balance_amount]"/>';
        $html += '</td>';
        // $html += '<td>';
        ...
        $html += '</td>';
        $html += '<td>';
        $html += '<input type="text" class="form-control" name="payments_details['+$grid_row+'][net_amount]" id="payments_detail_net_amount_'+$grid_row+'" value="'+roundUpto($document['outstanding_amount'],2)+'" readonly="true"/>';
        $html += '</td>';
...
$(document).on('click','#btnAddGrid', function() {
    ...
    $html += '</select>';
    $html += '</td>';
    $html += '<td  style="min-width: 450px !important;">';
    $html += '<input type="text" class="form-control" name="payments_details['+$grid_row+'][remarks]" id="payments_detail_remarks_'+$grid_row+'" value="" />';
    $html += '</td>';
    $html += '<td>';
    $html += '<input type="text" class="form-control dtpDate" name="payments_details['+$grid_row+'][cheque_date]" id="payments_detail_cheque_date_'+$grid_row+'" value="" />';
...
//    $html += '<td style="width: 200px">';
//    $html += '<select onchange="getSubProjects(this)" class="form-control required" id="payments_detail_project_id_'+ $grid_row +'" name="payments_details['+$grid_row+'][project_id]" required>';
//    $html += '<option value="">&nbsp;</option>';
//    $.each($projects, function($i, $project){
//        $html += '<option value="'+ $project['project_id'] +'">'+ $project['name'] +'</option>';
//    });
//    $html += '</select>';
//    $html += '<label for="payments_detail_project_id_'+ $grid_row +'" class="error" style="display:none"></label>';
//    $html += '</td>';
//
//    $html += '<td style="width: 200px">';
//    $html += '<select onchange="getJobOrders('+ $grid_row +')" class="form-control required" id="payments_detail_sub_project_id_'+ $grid_row +'" name="payments_details['+$grid_row+'][sub_project_id]" required>';
//    $html += '</select>';
//    $html += '<label for="payments_detail_sub_project_id_'+ $grid_row +'" class="error" style="display:none"></label>';
//    $html += '</td>';
//
//    $html += '<td style="width: 200px">';
//    $html += '<select class="form-control" id="payments_detail_job_order_id_'+ $grid_row +'" name="payments_details['+$grid_row+'][job_order_id]">';
