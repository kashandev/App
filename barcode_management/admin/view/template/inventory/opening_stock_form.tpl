                                        ...
                                        <div class="table-responsive">
                                            <table id="tblOpeningStockDetail" class="table table-bordered">
                                                ...
                                                <tr align="center" data-row_id="H">
                                                    <td style="width: 15px;"><a class="btnAddGrid btn btn-xs btn-primary" title="Add" href="javascript:void(0);"><i class="fa fa-plus"></i></a></td>
                                                ...
                                                <tbody>
                                                <?php $grid_row = 0; ?>
                                                <?php foreach($opening_stock_details as $grid_row => $detail): ?>
