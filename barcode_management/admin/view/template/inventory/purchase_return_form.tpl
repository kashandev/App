...
<div class="wrapper">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive form-group">
                                            <table id="tblPurchaseInvoice" class="table table-striped table-bordered">
                                                ...
                                                <tbody >
                                                <?php foreach($purchase_return_details as $grid_row => $detail): ?>
                                                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <select onchange="getProductById(this);" class="form-control select2" id="purchase_return_detail_product_id_<?php echo $grid_row; ?>" name="purchase_return_details[<?php echo $grid_row; ?>][product_id]" >
                                                                <option value="">&nbsp;</option>
                                                    ...
                                                    <td>
                                                        <select class="form-control select2" id="purchase_return_detail_warehouse_id_<?php echo $grid_row; ?>" name="purchase_return_details[<?php echo $grid_row; ?>][warehouse_id]" >
                                                            <option value="">&nbsp;</option>
                                                ...
                                                <?php endforeach; ?>
                                                <?php $grid_row = count($purchase_return_details); ?>
                                                </tbody>
                                                <tfoot>
                                                </tfoot>
                                            </table>
    ...
    <script type="text/javascript" src="dist/js/pages/inventory/purchase_return.js"></script>
