...
<div class="wrapper">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="table-responsive form-group">
                                            <table id="tblSaleReturn" class="table table-striped table-bordered">
                                                <thead>
                                                <tr align="center">
                                                ...
                                                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                                                    ...
                                                    <td>
                                                        <select class="form-control select2" id="sale_return_detail_warehouse_id_<?php echo $grid_row; ?>" name="sale_return_details[<?php echo $grid_row; ?>][warehouse_id]" >
                                                            <option value="">&nbsp;</option>
    ...
    <script type="text/javascript" src="dist/js/pages/inventory/sale_return.js"></script>
