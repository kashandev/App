...
<div class="row">
    ...
    <div class="col-sm-3">
  <div class="form-group">
        <label><?php echo $lang['challan_no']; ?></label>
        <input  type="text" class="form-control" name="challan_no" id="challan_no" value="<?php echo $challan_no; ?>" autocomplete="off" />
    </div>
        </div>
    <div class="col-sm-3">
        <div class="form-group">
            <label><?php echo $lang['its_no']; ?></label>
            <input  type="text" class="form-control" name="its_no" id="its_no" value="<?php echo $its_no; ?>" autocomplete="off" />
...
<div class="row">
    <div class="col-sm-12">
        <div class="table-responsive">
            <table id="tblBankReceiptDetail" class="table table-striped table-bordered" style="width: 2500px !important; max-width: 2500px !important;">
                <thead>
                <tr align="center">
                    <td style="width: 2.5%;"><a id="btnAddGrid" title="Add" href="javascript:void(0);"><i class="fa fa-plus"></i></a></td>
                    <td style="width: 5%;"><?php echo $lang['document_no']; ?></td>
                    ...
                    <td style="width: 10%;"><?php echo $lang['cheque_date']; ?></td>
                    <td style="width: 8%;"><?php echo $lang['cheque_no']; ?></td>
                    <td style="width: 7%;"><?php echo $lang['document_amount']; ?></td>
                    <td style="width: 7%;"><?php echo $lang['total_amount']; ?></td>
                    ...
                    <td style="width: 7%;"><?php echo $lang['net_amount']; ?></td>
                ...
                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td>
                        <select class="form-control select2" id="bank_receipt_detail_amaanat_no_<?php echo $grid_row; ?>" name="bank_receipt_details[<?php echo $grid_row; ?>][amaanat_no]">
                            <option value="">&nbsp;</option>
                    ...
                    <td>
                        <input onchange="calculateTaxes(this);" type="text" class="form-control" name="bank_receipt_details[<?php echo $grid_row; ?>][amount]" id="bank_receipt_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" />
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="text" class="form-control" name="bank_receipt_details[<?php echo $grid_row; ?>][net_amount]" id="bank_receipt_detail_net_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['net_amount']; ?>" readonly="true"/>
                    </td>
                    <td style="white-space: nowrap; width: 3.5%"><a onclick="removeRow(this);" title="Remove" class="btn btn-xs btn-danger" href="javascript:void(0);"><i class="fa fa-times"></i></a>
                        <a id="btnAddGrid" class="btn btn-xs btn-primary" title="Add" href="javascript:void(0);"><i class="fa fa-plus"></i></a>
                    </td>
