...
<div class="row">
    <div class="col-sm-12">
        <div class="table-responsive">
            <table id="tblCashReceiptDetail" class="table table-striped table-bordered" style="width: 2500px !important; max-width: 2500px !important;">
                <thead>
                <tr align="center">
                ...
                <tr id="grid_row_<?php echo $grid_row; ?>" data-row_id="<?php echo $grid_row; ?>">
                    ...
                    <td>
                        <input onchange="calculateTaxes(this);" type="text" class="form-control" name="cash_receipt_details[<?php echo $grid_row; ?>][amount]" id="cash_receipt_detail_amount_<?php echo $grid_row; ?>" value="<?php echo $detail['amount']; ?>" />
                    </td>
                    <td>
