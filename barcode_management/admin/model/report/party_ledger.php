...
class ModelReportPartyLedger extends HModel{
    ...
    public function getPartyOpening($filter = array(),$sort_order = array()) {
        $sql = "SELECT l.company_id, l.company_branch_id, l.fiscal_year_id, l.partner_type_id, p.partner_type, l.partner_id, p.name as partner_name,l.cheque_no,l.cheque_date";
    ...
    public function getPartySummary($filter = array()) {
        $sql = "SELECT l.partner_type, l.partner_name,l.cheque_no,l.cheque_date";
