...
class ModelInventorySaleOrder extends HModel{
    ...
    public function getProductJson($search, $page, $limit=25, $filter=array()) {
        ...
        $arrWhere[] = "`product_type` = 'Finished Goods'";
    ...
    public function getSaleOrders($filter, $excl_document_id='') {
        ...
        foreach($sale_orders as $sale_order) {
            ...
            $arrSaleOrders[$sale_order['document_identity']]['project_id'] = $sale_order['project_id'];
            $arrSaleOrders[$sale_order['document_identity']]['project'] = $sale_order['project'];
            $arrSaleOrders[$sale_order['document_identity']]['sub_project_id'] = $sale_order['sub_project_id'];
            $arrSaleOrders[$sale_order['document_identity']]['sub_project'] = $sale_order['sub_project'];
            ...
            if(isset($arrSaleOrders[$sale_order['document_identity']]['products'][$sale_order['product_id']])) {
                ...
                $arrSaleOrders[$sale_order['document_identity']]['products'][$sale_order['product_id']] = array(
                    ...
                    'product_master_id' => $sale_order['product_master_id'],
                    'product_code' => $sale_order['product_code'],
                    'serial_no' => $sale_order['serial_no'],
                    'batch_no' => $sale_order['batch_no'],
            ...
            $sql .= " AND product_master_id = '".$sale_order['product_id']."'";
            if($excl_document_id !='') {
