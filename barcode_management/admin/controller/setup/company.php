...
class ControllerSetupCompany extends HController {
    ...
    protected function getForm() {
        ...
        $this->data['action_validate_company_name'] = $this->url->link($this->getAlias() . '/validateCompanyName', 'token=' . $this->session->data['token'] . '&company_id=' . $this->request->get['company_id'], 'SSL');
        $this->data['action_validate_user_name'] = $this->url->link($this->getAlias() . '/validateUserName', 'token=' . $this->session->data['token'] . '&company_id=' . $this->request->get['company_id'], 'SSL');
