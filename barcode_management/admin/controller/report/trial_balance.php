...
class ControllerReportTrialBalance extends HController {
    ...
    public function printReportExcel()
    {
       ...
       // $arrFilter['company_branch_id'] = $session['company_branch_id'];
        $arrFilter['company_branch_id'] = $company_branch_id;
        ...
        $branch = $this->model['company_branch']->getRow(array('company_branch_id' => $company_branch_id));
    ...
    public function printReport() {
        ...
        $arrFilter['from_date'] = MySqlDate($post['date_from']);
        $arrFilter['company_id'] = $session['company_id'];
        $arrFilter['company_branch_id'] = $post['company_branch_id'];
        // d($arrFilter);
        $this->model['company'] = $this->load->model('setup/company');
        $this->model['company_branch'] = $this->load->model('setup/company_branch');
        $this->model['bank_receipt'] = $this->load->model('gl/bank_receipt');
        ...
        $company = $this->model['company']->getRow(array('company_id' => $this->session->data['company_id']));
        $branch = $this->model['company_branch']->getRow(array('company_branch_id' => $post['company_branch_id']));
        $department = $this->model['company_branch']->getRow(array('company_branch_id' => $post['company_branch_id']));
...
class PDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Ln(10);
        $this->Cell(0, 10, $this->data['department'], 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->SetFont('times', 'B,I', 16);
        $this->Ln(10);
