        ...
        this.keypress(function(d){
            ...
            if(a<48||a>57){
                if(settings.type=="decimal"){
                    ...
                    if(a==8||a==9||a==13||a==37||a==39||a==45||a==32||a==40||a==41||a==43){
                        //var re = new RegExp('(?:(?:(\s*\(?([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\)?\s*(?:[.-]\s*)?)([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})');
                        //myRe.exec(this.value+a);
                        return true
                    }
                    return false
                }else if(settings.type=="alphabet"){
