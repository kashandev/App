<?php
// HTTP
define('HTTP_SERVER', 'http://' . $_SERVER['HTTP_HOST'] . '/boot_store/');
define('HTTP_BASE', 'http://' . $_SERVER['HTTP_HOST'] . '/boot_store/assets/');
define('HTTP_IMAGE', 'http://' . $_SERVER['HTTP_HOST'] . '/boot_store/image/');
define('HTTP_EVENT_FILE', 'http://' . $_SERVER['HTTP_HOST'] . '/boot_store/event_file/');

// HTTPS
define('HTTPS_SERVER', 'http://' . $_SERVER['HTTP_HOST'] . '/boot_store/');
define('HTTPS_BASE', 'http://' . $_SERVER['HTTP_HOST'] . '/boot_store/assets/');
define('HTTPS_IMAGE', 'http://' . $_SERVER['HTTP_HOST'] . '/boot_store/image/');
define('HTTPS_EVENT_FILE', 'http://' . $_SERVER['HTTP_HOST'] . '/boot_store/event_file/');
...
define('DB_PASSWORD', '');
define('DB_DATABASE', 'jefco_master');
define('DB_PREFIX', '');
...
// Config
define('CONFIG_APPLICATION_CODE', 'bs');
define('CONFIG_APPLICATION_NAME', 'Boot Store');
