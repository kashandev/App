...
//        );
        ...
        $pdf->Cell(24, 4, $partner['name'], 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->setY(15,true);
        $pdf->Cell(22, 4, $invoice['customer_no'], 0, false, 'L', 0, '', 0, false, 'M', 'M');

        $pdf->Cell(30, 4, '', 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(20, 4, $invoice['document_identity'], 0, false, 'R', 0, '', 0, false, 'M', 'M');
        $pdf->setXY(22,11,true);
        $pdf->Cell(27, 4, '', 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Cell(24, 4, $invoice_date, 0, false, 'R', 0, '', 0, false, 'M', 'M');
        $pdf->Ln(7);
       ...
       // $pdf->Cell(24, 4, $partner['mobile'], 0, false, 'L', 0, '', 0, false, 'M', 'M');
        ...
        $total_balance = ($total_net_amount + $previous_balance - $invoice['cash_received']);
        $pdf->Ln(4);
        $pdf->Cell(80, 4, '', 'T', false, 'L',0, '', 0, false, 'M', 'M');
        $pdf->Ln(2);
        $pdf->setX(38);
        ...
        $pdf->setX(57);
        $pdf->Cell(15, 4, number_format($invoice['cartage'],0), 0, false, 'R', 0, '', 0, false, 'M', 'M');
        $pdf->Ln(4);
        $pdf->setX(37);
        ...
        //Close and output PDF document
        $pdf->Output('Sale Receipt:'.date('YmdHis').'.pdf', 'I');
    }
...
//         $pdf->SetCreator(PDF_CREATOR);
//         $pdf->SetAuthor('Huzaifa Khambaty');
//         $pdf->SetTitle('Sale Invoice Estimate');
//         $pdf->SetSubject('Sale Invoice Estimate');
...
//         //Close and output PDF document
//         $pdf->Output('Sale Invoice Estimate - '.$invoice['document_identity'].'.pdf', 'I');
    ...
    public function Header() {
        ...
        */
        ...
        if($this->data['type'] == "sale_invoice")
        {
            ...
            $this->Ln(5);
            // Title
            $this->Cell(135, 12, 'Sale Invoice', 0, false, 'C', 0, '', 0, false, 'M', 'M');
            $this->setX(150);
            $this->Cell(135, 12, 'Sale Invoice', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        }
        else {
            ...
            $this->Ln(8);
            // Title
            $this->Cell(105, 12, 'Sale Bill', 0, false, 'R', 0, '', 0, false, 'M', 'M');
            $this->Ln(10);
